...
modality <- senses_01$Modality
Val <- senses_01$Val
plot(1:114,Val,ylim=c(5,6.5),ylab="Val",xlab="order", pch=21,bg= as.numeric(as.factor(modality))+1 )
#abline(h=mean(Val[modality=="Sight"]),col="darkgreen")
#abline(h=mean(Val[modality=="Smell"]), col="darkred")
abline(h=mean(Val[modality=="Sound"]), col="red")
#abline(h=mean(Val[modality=="Taste"]), col="cornflowerblue")
abline(h=mean(Val[modality=="Taste"]), col="green")
```
