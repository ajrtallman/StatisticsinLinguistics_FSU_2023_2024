...
All of the following are from the same data, but you can give
...
Let's open the iconicty data.


```{r}
icon.data <- read.csv("/Users/Adan Tallman/Desktop/2023 01 30/perry_winter_2017_iconicity.csv", header=TRUE)
head(icon.data)
```
```{r}
library(partykit)
